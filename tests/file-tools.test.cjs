...
describe('qGlob', () => {
  ...
  it('public/**/*.jsx should return a string containing "public/app.jsx"', () => {
    const result = qGlob('public/**/*.jsx');
    expect(typeof result).toBe('string');
    expect(result).toContain('public/app.jsx');
  });
...
describe('qRead', () => {
 ...
 expect(
   result.toLowerCase()
 ).toMatch(/port|model|host|key|url|name|version|token|api|secret|provider|temperature|max/);
  });
