...
const shellIntegrationSupportedShellTypes: (
  PosixShellType | GeneralShellType | WindowsShellType
)[] = [
  PosixShellType.Bash,
  PosixShellType.Zsh,
...
export class TerminalInstance extends Disposable implements ITerminalInstance {
  ...
  get extEnvironmentVariableCollection():
    IMergedEnvironmentVariableCollection | undefined {
  ...
  constructor(
    ...
    this._isRemoteResolverTerminal =
      this._shellLaunchConfig[remoteResolverTerminal] === true;
  ...
  private _getDimension(
    ...
    const horizontalPadding =
      ...
      this.xterm.scrollbarWidth; /*scroll bar padding*/
      ...
      await Promise.race([
        new Promise<void>((r) => {
          ...
          if (commandDetection) {
            ...
            store.add(
              this.capabilities.onDidAddCommandDetectionCapability(
                waitForPromptInput,
              ),
            );
          }
  ...
  protected _createProcessManager(): TerminalProcessManager {
    let deserializedCollections:
      ReadonlyMap<string, IEnvironmentVariableCollection> | undefined;
    if (
      ...
      hoverActions: [
        {
          ...
          run: () => {
            this._openerService.open(
              "https://code.visualstudio.com/docs/terminal/shell-integration?referrer=in-product",
            );
          },
        },
        {
