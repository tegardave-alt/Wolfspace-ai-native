  ...
  private async _deleteAllHiddenTerminals(): Promise<void> {
    ...
    type DeleteHiddenChatTerminalsClassification = {
      ...
      count: {
        ...
        isMeasurement: true;
        comment: "The number of hidden chat terminals that were deleted.";
      };
    };
    this._telemetryService.publicLog2<
      DeleteHiddenChatTerminalsEvent,
      DeleteHiddenChatTerminalsClassification
    >("terminal.chatDeleteHiddenTerminals", {
