...
export interface ITerminalChatService {
   ...
   */
  registerTerminalInstanceWithExecutionId(
   ...
   */
  getTerminalInstanceByExecutionId(
    terminalExecutionId: string,
  ...
  registerOutputSource(
    terminalToolSessionId: string,
    source: IChatTerminalOutputSource,
  ): IDisposable;
  getOutputSource(
    terminalToolSessionId: string | undefined,
  ): IChatTerminalOutputSource | undefined;
  ...
  ): Promise<ToolConfirmationAction[] | undefined>;
  ...
  registerAhpCommandSource(
    ...
    promisedTerminal: Promise<ITerminalInstance>,
  ): IDisposable;
