...
// COPIED FROM microsoft/vscode extensions/git/src/git.ts, and it BUILDS here.
// See ../README.md for the commit, the date, and why this file is on the
// build path when vendor/vscode-terminal is not: it imports one line from
// 'vscode' and that line is now ./vscode, a shim of the seven things it asks
// for. Every other change to this file is marked WOLFSPACE: inline.
...
// WOLFSPACE: file-type@16, the last CommonJS release. Upstream targets v17+,
// which is ESM-only and exports fileTypeFromBuffer; v16 exports fromBuffer with
// the same contract. The call site below is the one other change.
